-- set seed to 0;
-- create temp table store_sales as (select * from store_sales order by random() limit 500000);
-- set seed to 0;
-- create temp table household_demographics as (select * from household_demographics order by random() limit 500000);
-- set seed to 0;
-- create temp table time_dim as (select * from time_dim order by random() limit 500000);
-- set seed to 0;
