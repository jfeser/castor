...
(*     if Is_serializable.is_static r then return @@ Flat r else None *)
...
(*       let r = *)
(*         Schema.annotate_schema r |> Is_serializable.annotate_stage *)
(*         |> Visitors.map_meta (fun meta -> *)
(*                object *)
(*                  method stage = meta#stage *)
(*                  method resolved = meta#meta#meta#resolved *)
(*                end) *)
(*       in *)
