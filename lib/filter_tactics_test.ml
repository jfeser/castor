        ...
        dedup(
          filter(true,
            groupby([ps_partkey, ps_suppkey, ps_availqty, ps_supplycost, ps_comment],
              ...
              select([s0.ps_partkey, s0.ps_suppkey, s0.ps_availqty,
                      s0.ps_supplycost, s0.ps_comment],
            ...
            join((s_nationkey = n_nationkey),
              ...
              select([s_suppkey, s_name, s_address, s_nationkey, s_phone,
                ...
                groupby([s1_s_acctbal, s1_s_address, s1_s_comment, s1_s_name,
                         s1_s_nationkey, s1_s_phone, s1_s_suppkey, s_suppkey,
                         s_name, s_address, s_nationkey, s_phone, s_acctbal,
                         s_comment],
                  [s_suppkey, s_name, s_address, s_nationkey, s_phone, s_acctbal,
                   s_comment, s1_s_acctbal, s1_s_address, s1_s_comment, s1_s_name,
                   s1_s_nationkey, s1_s_phone, s1_s_suppkey],
                  select([s1_s_acctbal, s1_s_address, s1_s_comment, s1_s_name,
                          s1_s_nationkey, s1_s_phone, s1_s_suppkey,
                          s1_s_suppkey as s_suppkey, s1_s_name as s_name,
                          s1_s_address as s_address, s1_s_nationkey as s_nationkey,
                          s1_s_phone as s_phone, s1_s_acctbal as s_acctbal,
                          s1_s_comment as s_comment],
                    join(((s1_s_suppkey = ps_suppkey) && true),
                      ...
                      select([ps_partkey, ps_suppkey, ps_availqty, ps_supplycost,
                        ...
                        groupby([s3_ps_availqty, s3_ps_comment, s3_ps_partkey,
                                 s3_ps_suppkey, s3_ps_supplycost, ps_partkey,
                                 ps_suppkey, ps_availqty, ps_supplycost, ps_comment],
                          [ps_partkey, ps_suppkey, ps_availqty, ps_supplycost,
                           ps_comment, s3_ps_availqty, s3_ps_comment,
