...
type 'f agg = Count | Key of 'f | Sum of 'f | Avg of 'f | Min of 'f | Max of 'f
[@@deriving compare, sexp, bin_io, hash]
...
class virtual ['f1, 'r1, 'l1, 'f2, 'r2, 'l2] map =
  object (self)
    ...
    method run  : ('f1, 'r1, 'l1) t -> ('f2, 'r2, 'l2) t=
      function
